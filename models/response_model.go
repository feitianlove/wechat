...
// 设置返回消息
func NewResponseHead(seq string, cmd string, code ecode.ECode, codeMsg string, data interface{}) *Head {
...
func NewResponse(code ecode.ECode, codeMsg string, data interface{}) *Response {
